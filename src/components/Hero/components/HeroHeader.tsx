    ...
    <header className={styles.heroHeader}>
      <div className={isMobile ? styles.headerMobile : styles.headerDesktop}>
        ...
        <nav className={styles.socialLinks} aria-label="Social links">
          ...
          <div className={styles.socialIconWrapper}>
            <a
              href="https://x.com/Abhiinav02"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialIcon}
              aria-label="Twitter"
              onClick={analytics.trackTwitter}
            >
              <TwitterIcon />
            </a>
            <div className={styles.socialTooltip}>
        ...
        {!isMobile && (
          <p className={styles.heroDescription}>
            ...
            <Link
              ...
              onClick={() => analytics.trackProcess()}
            >
          ...
          <div className={styles.ctaWrapper}>
            <button
              ...
              onClick={() => {
                ...
                window.open('https://drive.google.com/file/d/1iitbU5CBoTVMvmEUIY61v80JV-yhUrzC/view?usp=sharing', '_blank');
              }}
            >
